...
// Modul "orkestrues" — vetem ky importon Business + Services + Employees + Schedules
...
@Module({
  imports: [BusinessModule, UsersModule, ServicesModule, EmployeesModule, SchedulesModule],
  providers: [BusinessActivationChecker, BusinessSetupReminderService, BusinessActivationConsumer],
})
