import { BusinessMemberEntity, BusinessMemberRole } from "../entities/business-member.entity";
...
export abstract class BusinessMemberFindRepository {
  ...
  abstract findByBusinessAndRoles(businessId: string, roles: BusinessMemberRole[]): Promise<BusinessMemberEntity[]>;
}