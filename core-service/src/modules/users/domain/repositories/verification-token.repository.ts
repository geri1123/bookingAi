...
import { VerificationTokenEntity, TokenType } from "../entities/verification-token.entity";
...
export abstract class VerificationTokenRepository {
  ...
  abstract invalidateActiveTokens(userId: string, type: TokenType, tx?: Prisma.TransactionClient): Promise<void>;
}