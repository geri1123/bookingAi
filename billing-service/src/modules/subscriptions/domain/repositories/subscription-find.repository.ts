...
export abstract class SubscriptionFindRepository {
  ...
  // Perdoret nga webhook-u i Paddle: eventet e Paddle referojne subscription
  // ID/customer ID te TYRE (externalReference), jo businessId tone direkt.
  abstract findByExternalReference(externalReference: string): Promise<SubscriptionEntity | null>;
