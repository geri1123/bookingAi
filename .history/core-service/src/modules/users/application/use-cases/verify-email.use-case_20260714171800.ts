...
export class VerifyEmailUseCase {
  ...
  async execute(input: VerifyEmailInput): Promise<void> {
    ...
    // Nese eshte verifikuar tashme (p.sh. dy klikime paralele ne te njejtin link),
    // mos hidh error — thjesht mos bej asgje me (idempotent).
    ...
    // Atomike: ose te dyja ndodhin (user u aktivizua + token u shenua i perdorur),
    // ose asnjera — shmang rastin ku useri aktivizohet por token-i mbetet i riperdorshem.
