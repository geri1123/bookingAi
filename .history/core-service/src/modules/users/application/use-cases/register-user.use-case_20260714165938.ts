...
export class RegisterUserUseCase {
  ...
  async execute(input: RegisterUserInput): Promise<UserEntity> {
    ...
    // Shenim: rasti P2002 (email/username i zene nga nje race condition,
    // p.sh. dy requests njekohesisht) trajtohet brenda
    // PrismaUserCreateRepository.create(), jo ketu — per te shmangur
    // logjike te dubluar ne dy layer te ndryshme.
